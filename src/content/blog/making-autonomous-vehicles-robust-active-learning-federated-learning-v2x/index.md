---
title: "Making autonomous vehicles robust with active learning, federated learning & V2X communication"
slug: making-autonomous-vehicles-robust-active-learning-federated-learning-v2x
date: 2021-09-03T08:18:00
updated: 2024-12-09T19:12:13
categories: [research]
tags: [federated-learning, use-cases, privacy-preserving-machine-learning, privacy-enhancing-technologies-pets]
authors: [krunal-kshirsagar]
draft: false
legacyId: 1608
---
...
![](./media/active-learning-loop-updated-copy-01-1.png)

<figcaption>Image Credit: Krunal Kshirsagar (OpenMined)</figcaption></figure>

1.  _Initialise the Active Learner(Query Selector)._
2.  _The learner then predicts the informative-ness of each data point from the unlabelled data pool and chooses the most informative unlabelled sample._
3.  _An oracle labels the query data and adds them to the training dataset._
4.  _The learner is re-trained on the updated dataset, that’s one iteration._
5.  _Repeat the steps with other rounds of informative-ness estimation._
...
![](./media/av-procedure-artboard-1-3-04-1.png)

<figcaption>Image Credit: Krunal Kshirsagar (OpenMined)</figcaption></figure>

1.  _Initially, a model is trained on the global dataset and a copy of that model is maintained across multiple autonomous vehicles._
2.  _Driving through the city, the autonomous vehicles trains the local model on the local data that they’ve gathered and sent back the local data as well as federate the updated local machine learning models’ parameters to the cloud simultaneously at a regular interval._
3.  _On the cloud, active learning is performed on the gathered dataset and a subset of relevant and informative data is extracted and added to the training data pool._
4.  _Next, the local machine learning models are aggregated and the global model is updated._
5.  _Later, The global model is then trained on the training pool._
6.  _Lastly, the global model parameters are federated across multiple autonomous vehicles and the local machine learning models’ parameters are updated._

<figure class="">

![](./media/av-procedure-artboard-4-6-artboard-1-artboard-1.png)
...
14.  [Autonomous driving with deep learning: a survey  
     of state-of-art technologies](https://arxiv.org/ftp/arxiv/papers/2006/2006.06091.pdf)
...
-   **Twitter:** [https://twitter.com/openminedorg](https://twitter.com/openminedorg)
-   **Slack:** [https://slack.openmined.org](https://slack.openmined.org/)

### Krunal Kshirsagar:

-   **Twitter:** [https://twitter.com/krunal\_wrote](https://twitter.com/krunal_wrote)
-   **Portfolio:** [https://noob-can-compile.github.io/home/](https://noob-can-compile.github.io/home/)
-   **Github:** [https://github.com/Noob-can-Compile](https://github.com/Noob-can-Compile)
-   **Slack:** @Krunal
